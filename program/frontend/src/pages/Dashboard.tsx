...
import { Cpu, Database, Activity, HardDrive, Wifi, ShieldAlert, Car, Navigation } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-panel-glow rounded-3xl p-5 flex flex-col justify-between">
          ...
          <div className="relative aspect-video rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 flex justify-center items-center">
            {streamFrame ? (
              <img src={streamFrame} alt="Traffic Video Stream" className="w-full h-full object-cover" />
            ) : (
              <div className="text-center p-8">
                <div className="w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
                <p className="text-slate-400 text-sm">等待边缘推流信号源输入...</p>
                <p className="text-xs text-slate-600 mt-2">请确保 edge_device 与 cloud_server 服务均在运行且推送正常</p>
              </div>
            )}
